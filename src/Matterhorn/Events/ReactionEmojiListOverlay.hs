...
onEventReactionEmojiListOverlay =
    void . onEventListOverlay (csCurrentTeam.tsReactionEmojiListOverlay) reactionEmojiListOverlayKeybindings
...
reactionEmojiListOverlayKeyHandlers =
    [ mkKb CancelEvent "Close the emoji search window" (exitListOverlay (csCurrentTeam.tsReactionEmojiListOverlay))
    ...
    , mkKb ActivateListItemEvent "Post the selected emoji reaction" (listOverlayActivateCurrent (csCurrentTeam.tsReactionEmojiListOverlay))
    ]
