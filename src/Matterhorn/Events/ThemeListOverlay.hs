...
onEventThemeListOverlay =
    void . onEventListOverlay (csCurrentTeam.tsThemeListOverlay) themeListOverlayKeybindings
...
themeListOverlayKeyHandlers =
    [ mkKb CancelEvent "Close the theme list" (exitListOverlay (csCurrentTeam.tsThemeListOverlay))
    ...
    , mkKb ActivateListItemEvent "Switch to the selected color theme" (listOverlayActivateCurrent (csCurrentTeam.tsThemeListOverlay))
    ]
